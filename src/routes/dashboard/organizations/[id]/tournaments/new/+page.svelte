...
<div class="mx-auto w-full max-w-2xl">
	<div class="mb-8">
		...
		<h1 class="text-2xl font-bold text-gray-900">{$t('tournaments.new.title')}</h1>
	</div>
		...
		>
			...
			<div class="grid gap-4 sm:grid-cols-2">
				<div>
					<label for="startDate" class="mb-2 block text-sm font-medium text-gray-700">
						{$t('tournaments.new.startDateLabel')}
					</label>
					<DateInput
						id="startDate"
						name="startDate"
				...
				<div>
					<label for="endDate" class="mb-2 block text-sm font-medium text-gray-700">
						{$t('tournaments.new.endDateLabel')}
					</label>
					<DateInput
						id="endDate"
						name="endDate"
			...
			<div>
				<label for="deadline" class="mb-2 block text-sm font-medium text-gray-700">
					{$t('tournaments.new.deadlineLabel')}
				</label>
				<input
					type="datetime-local"
					id="deadline"
